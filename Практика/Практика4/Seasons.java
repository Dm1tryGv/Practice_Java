...
public enum Seasons {
    ...
    public static void main(String[] args) {
        Seasons favouriteSeason;
        favouriteSeason = Seasons.SUMMER;
        System.out.println(favouriteSeason);
        System.out.println(favouriteSeason.getDescription());
        System.out.println("Средняя температура = " + favouriteSeason.getAverageTemperature());
        System.out.println();
        System.out.println();
